...
const ProductItem = (props) => {
    const { img } = props;
    return (
        <div className="bg-itemsBackground flex flex-row gap-3 w-full h-auto py-6
            mobileSmall:flex-col mobileSmall:border-none mobileSmall:justify-center mobileSmall:items-center mobileSmall:bg-backGround
            laptop:flex-row laptop:bg-itemsBackground laptop:gap-8 laptop:w-full laptop:h-auto laptop:py-6 laptop:mb-3
        ">
            ...
            <p className="flex text-2xl text-textColor font-Montserra leading-loose font-bold
